...
import { Mail, Lock, Scale, Shield, FileText, Briefcase } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-[#25343F]">
          ...
          <div className="text-center space-y-8">
            ...
            >
              ...
              empowering you to automate document creation, efficiently manage 
              contracts, and mitigate risk, all in one streamlined solution.
            </motion.p>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6 }}
        className="w-full lg:w-1/2 flex items-center justify-center bg-[#25343F] p-8"
      >
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-400">Welcome back! Please enter your login details</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="text-sm text-[#FF9B51] hover:text-[#FFB173]">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <Link href="/signup" className="text-[#FF9B51] hover:text-[#FFB173] font-semibold">
              Sign up
            </Link>
          </div>
        </div>
